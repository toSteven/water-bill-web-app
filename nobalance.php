...
<body>
    <div class="sidebar">
        ...
        <ul class="nav_list">
            ...
            <li>
                <a href="setiing.php" title="Setting">
                <i class='bx bx-cog'></i>
                ...
                <table id="client-data-table" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $client = mysqli_query($conn,"SELECT client.id, client.name, client.address, payment_status.status FROM client INNER JOIN payment_status ON client.unique_id=payment_status.unique_id WHERE payment_status.status='paid';");
                        ...
                        ?>
                            <tr>
                                ...
                                <?php }else{  ?><td style="text-align: center;"><span><?php echo "no balance"; } ?>
